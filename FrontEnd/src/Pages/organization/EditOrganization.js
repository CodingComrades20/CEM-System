...
export default function EditOrganization() {
  ...
  const fetchOrganization = async () => {
    try {
      ...
      const { organizationName, address, country, phoneNumber, email } = response.data;
      setOrganization({
        organizationName,
        address,
        country,
  ...
  const onSubmit = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:8081/organization/${id}`, organization);
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
          <h2 className="text-center m-4">Edit Organization</h2>
